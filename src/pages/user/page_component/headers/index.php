    ...
    <div class="container-fluid d-flex justify-content-between pt-2">
        ...
        <div class="collapse navbar-collapse" id="nav__user_nav_bar">
            <ul class="navbar-nav me-auto mt-2 mb-2 mb-lg-0" style="font-size:15pt">
                <li class="nav-item">
                    <a class="header-link nav-link d-flex align-items-center me-lg-2 active" goto="page_home">
                        <i class="fa-solid fa-house d-block d-md-none me-2 fa-fw"></i>
                        Home
                    </a>
                </li>
                <li class="nav-item">
                    <a class="header-link nav-link d-flex align-items-center me-lg-2" goto="page_events">
                        <i class="fa-solid fa-calendar-day d-block d-md-none me-2 fa-fw"></i>
                        Events
                    </a>
                </li>
                <li class="nav-item">
                    <a class="header-link nav-link d-flex align-items-center me-lg-2" goto="page_about">
                        <i class="fa-solid fa-circle-question d-block d-md-none me-2 fa-fw"></i>
                        About Us
                    </a>
                </li>
                <li class="nav-item">
                    <a class="header-link nav-link d-flex align-items-center me-lg-2" mainFunction="loadMembers" goto="page_members">
            ...
            <div class="d-flex justify-content-center mt-md-0 mt-3">
                <button class="btn me-2" style="color:#E9C001; font-weight:400" id="btn__header_login">Login</button>
