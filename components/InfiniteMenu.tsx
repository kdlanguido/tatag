      ...
      {activeItem && (
        ...
        `}
          ...
          ${isMoving
                ...
                : 'bottom-[1em] opacity-100 pointer-events-auto duration-[500ms] scale-100 -translate-x-1/2'
              }

            
        `}
          >
            <p className={`${headingFont.className} select-none relative text-[#060010] text-xs`}>Visit Chapter</p>
          </div>
        </>
      )}
    </div>
