...
export default function ChapterCard({ chapter, profile }: { chapter: ChapterICustom, profile: UserI }) {
    return (
        <Link href={
            profile?.membership?.memberLevel === "admin" ?
                "/admin/chapters/" + chapter._id : "#"
        }>
