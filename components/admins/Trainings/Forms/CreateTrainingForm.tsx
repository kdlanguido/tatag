...
export default function CreateTrainingForm({
    ...
    const [state, action, pending] = useActionState(createTraining, {
        success: null
    })
    ...
    useEffect(() => {
        ...
        if (!state.success) {
            toast.success("Notification", {
                description: "Encountered an error while creating the training.",
            })
        }
    }, [state])
        ...
        <div className='flex flex-1 flex-col gap-4 p-4'>
            ...
            <div className="w-full md:w-1/2">
                ...
                <div className="mb-5 text-center md:text-start">
                    <h1 className="font-semibold">Create a New Training</h1>
                    <h1 className=" text-sm text-muted-foreground">Training information</h1>
                </div>
